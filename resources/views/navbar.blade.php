...
if ($pagelink == 'index.php') {
    $home_active = "active";
}if ($pagelink == 'about.php') {
    $about_active = "active";
}if (($pagelink == 'business_consulting_services.php') || ($pagelink == 'commercial_loan_services.php') || ($pagelink == 'website_services.php') ) {
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu border-light m-0">
                            <a href="business_consulting_services.php" class="dropdown-item">Business Consulting Services</a>
                            <a href="commercial_loan_services.php" class="dropdown-item">Commercial Loan Services</a>
                            <a href="website_services.php" class="dropdown-item">Website Services</a>
                            <a href="review.php" class="dropdown-item">Testimonials & Reviews</a>
                            <a href="faq.php" class="dropdown-item">FAQ - $pagelink</a>
                        </div>
                    </div>
                    <a href="index.php#contact" class="nav-item nav-link">Contact Us</a>
                </div>
                <div class="d-none d-lg-flex ms-2">
                    <a class="btn btn-light btn-sm-square rounded-circle ms-3" href="https://facebook.com/profile.php?id=100089153356909">
