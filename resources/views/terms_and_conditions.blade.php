...
<head>
    <meta charset="utf-8">
    <title>:: JAS Chat Group Inc - Terms and Condition ::</title>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-12">
                    ...
                    <i>Last updated January 01, 2024</i><br>
                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-md-12 mb-5">
                            ...
                            We are JAS Chat Group Inc. ("Company," "we," "us," "our"), a company registered in Ohio, United States at 25 Main Street, Suite 200, Westlake, OH 44145.<br>

                            We operate the website <a href="https://www.jaschatgroup.com/">www.jaschatgroup.com</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").<br>

                            You can contact us by phone at 1-216-302-8252, email at John@jaschatgroup.com, or by mail to 25 Main Street, Suite 200, Westlake, OH 44145, United States.<br>

                            These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and JAS Chat Group Inc., concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.<br>

                            We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by john@jaschatgroup.com, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.<br>
                            ...
                            <ol class="pp_cs">
                                ...
                                <li><a href="#purchases">4. PURCHASES AND PAYMENT</a></li>
                                <li><a href="#returnno">5. POLICY</a></li>
                                <li><a href="#prohibited">6. PROHIBITED ACTIVITIES</a></li>
                                <li><a href="#ugc">7. USER GENERATED CONTRIBUTIONS</a></li>
                                <li><a href="#license">8. CONTRIBUTION LICENSE</a></li>
                                <li><a href="#reviews">9. GUIDELINES FOR REVIEWS</a></li>
                                <li><a href="#thirdparty">10. THIRD-PARTY WEBSITES AND CONTENT</a></li>
                                <li><a href="#advertisers">11. ADVERTISERS</a></li>
                                <li><a href="#sitemanage">12. SERVICES MANAGEMENT</a></li>
                                <li><a href="#ppyes">13. PRIVACY POLICY</a></li>
                                <li><a href="#terms">14. TERM AND TERMINATION</a></li>
                                <li><a href="#modifications">15. MODIFICATIONS AND INTERRUPTIONS</a></li>
                                <li><a href="#law">16. GOVERNING LAW</a></li>
                                <li><a href="#disputes">17. DISPUTE RESOLUTION</a></li>
                                ...
                                <li><a href="#userdata">22. USER DATA</a></li>
                                <li><a href="#electronic">23. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
                                <li><a href="#california">24. CALIFORNIA USERS AND RESIDENTS</a></li>
                                <li><a href="#misc">25. MISCELLANEOUS</a></li>
                                <li><a href="#contact">26. CONTACT US</a></li>
                            </ol>


                            <br>

                            <h5 id="services">OUR SERVICES</h5><br>
                            ...
                            The Services are not tailored to comply with industry-specific regulations (Health Insurance Portability and Accountability Act (HIPAA), Federal Information Security Management Act (FISMA), etc.), so if your interactions would be subjected to such laws, you may not use the Services. You may not use the Services in a way that would violate the Gramm-Leach-Bliley Act (GLBA).<br><br>

                            

                            <h5 id="ip">INTELLECTUAL PROPERTY RIGHTS</h5><br>
                            ...
                            <b>Your use of our Services</b><br>
                            ...
                            access the Services; and download or print a copy of any portion of the Content to which you have properly gained access.<br>
                            ...
                            If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: John@jaschatgroup.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.<br><br>
                            ...
                            Please review this section and the "<a href="#prohibited">PROHIBITED ACTIVITIES</a>" section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.<br><br>
                            ...
                            confirm that you have read and agree with our "<a href="#prohibited">PROHIBITED ACTIVITIES</a>" and will not post, send, publish, upload, or transmit through the Services any Submission that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading;<br>
                            ...
                            <h5 id="userreps">USER REPRESENTATIONS</h5><br>

                            By using the Services, you represent and warrant that: (1) you have the legal capacity and you agree to comply with these Legal Terms; (2) you are not a minor in the jurisdiction in which you reside; (3) you will not access the Services through automated or non-human means, whether through a bot, script or otherwise; (4) you will not use the Services for any illegal or unauthorized purpose; and (5) your use of the Services will not violate any applicable law or regulation.<br><br>

                            If you provide any information that is untrue, inaccurate, not current, or incomplete, we have the right to suspend or terminate your account and refuse any and all current or future use of the Services (or any portion thereof).
                            <br><br>

                            <h5 id="purchases">PURCHASES AND PAYMENT</h5><br>
                            ...
                            <h5 id="returnno">POLICY</h5><br>

                            All sales are final and no refund will be issued.<br><br>


                            <h5 id="prohibited">PROHIBITED ACTIVITIES</h5><br>
                            ...
                            <h5 id="ugc">USER GENERATED CONTRIBUTIONS</h5><br>
                            ...
                            Any use of the Services in violation of the foregoing violates these Legal Terms and may result in, among other things, termination or suspension of your rights to use the Services.<br><br>


                            <h5 id="license">CONTRIBUTION LICENSE</h5><br>
                            ...
                            <h5 id="reviews">GUIDELINES FOR REVIEWS</h5><br>
                            ...
                            <h5 id="thirdparty">THIRD-PARTY WEBSITES AND CONTENT</h5><br>

                            The Services may contain (or you may be sent via the Site) links to other websites ("Third-Party Websites") as well as articles, photographs, text, graphics, pictures, designs, music, sound, video, information, applications, software, and other content or items belonging to or originating from third parties ("Third-Party Content"). Such Third-Party Websites and Third-Party Content are not investigated, monitored, or checked for accuracy, appropriateness, or completeness by us, and we are not responsible for any Third-Party Websites accessed through the Services or any Third-Party Content posted on, available through, or installed from the Services, including the content, accuracy, offensiveness, opinions, reliability, privacy practices, or other policies of or contained in the Third-Party Websites or the Third-Party Content. Inclusion of, linking to, or permitting the use or installation of any Third-Party Websites or any Third-Party Content does not imply approval or endorsement thereof by us. If you decide to leave the Services and access the Third-Party Websites or to use or install any Third-Party Content, you do so at your own risk, and you should be aware these Legal Terms no longer govern. You should review the applicable terms and policies, including privacy and data gathering practices, of any website to which you navigate from the Services or relating to any applications you use or install from the Services. Any purchases you make through Third-Party Websites will be through other websites and from other companies, and we take no responsibility whatsoever in relation to such purchases which are exclusively between you and the applicable third party. You agree and acknowledge that we do not endorse the products or services offered on Third-Party Websites and you shall hold us blameless from any harm caused by your purchase of such products or services. Additionally, you shall hold us blameless from any losses sustained by you or harm caused to you relating to or resulting in any way from any Third-Party Content or any contact with Third-Party Websites.<br><br>


                            <h5 id="advertisers">ADVERTISERS</h5><br>

                            We allow advertisers to display their advertisements and other information in certain areas of the Services, such as sidebar advertisements or banner advertisements. We simply provide the space to place such advertisements, and we have no other relationship with advertisers.<br><br>

                            
                            <h5 id="sitemanage">SERVICES MANAGEMENT</h5><br>
                            ...
                            <h5 id="ppyes">PRIVACY POLICY</h5><br>

                            We care about data privacy and security. Please review our Privacy Policy: <a href="http://www.jaschatgroup.com/privacy-policy">https://www.jaschatgroup.com/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.<br><br>


                            <h5 id="terms">TERM AND TERMINATION</h5><br>
                            ...
                            <h5 id="modifications">MODIFICATIONS AND INTERRUPTIONS</h5><br>
                            ...
                            <h5 id="law">GOVERNING LAW</h5><br>

                            These Legal Terms and your use of the Services are governed by and construed in accordance with the laws of the State of Ohio applicable to agreements made and to be entirely performed within the State of Ohio, without regard to its conflict of law principles.<br><br>


                            <h5 id="disputes">DISPUTE RESOLUTION</h5><br>
                            ...
                            If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association ("AAA") and, where appropriate, the AAA's Supplementary Procedures for Consumer Related Disputes ("AAA Consumer Rules"), both of which are available at the American Arbitration Association (AAA) website. Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in Cuyahoga, Ohio. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.<br><br>

                            If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Cuyahoga, Ohio, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.<br><br>
                            ...
                            <b>Exceptions to Informal Negotiations and Arbitration</b><br>
                            ...
                            <h5 id="corrections">CORRECTIONS</h5><br>
                            ...
                            <h5 id="disclaimer">DISCLAIMER</h5><br>
                            ...
                            <h5 id="liability">LIMITATIONS OF LIABILITY</h5><br>
                            ...
                            <h5 id="indemnification">INDEMNIFICATION</h5><br>
                            ...
                            <h5 id="userdata">USER DATA</h5><br>
                            ...
                            <h5 id="electronic">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h5><br>
                            ...
                            <h5 id="california">CALIFORNIA USERS AND RESIDENTS</h5><br>
                            ...
                            <h5 id="misc">MISCELLANEOUS</h5><br>
                            ...
                            <h5 id="contact">CONTACT US</h5><br>
                            ...
                            United States<br>
                            Phone: 1-216-302-8252<br>
                            john@jaschatgroup.com<br>
