    ...
    <div class="col-md-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        <label for="manufacturer" class="col-md-4 col-form-label text-md-end text-start"><strong>Manufacturer:</strong></label>
                    ...
                    <div class="row">
                        <label for="code" class="col-md-4 col-form-label text-md-end text-start"><strong>Year of Manufacture:</strong></label>
                        <div class="col-md-6" style="line-height: 35px;">
                            {{ $product->manufacture_at }}
                        </div>
                    </div>
